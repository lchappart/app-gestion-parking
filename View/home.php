    ...
    <section class="features-section">
        ...
        <div class="features-grid">
            <div class="feature-card">
                ...
                <p>Réservez votre place en quelques clics, 24h/24 et 7j/7</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p>Suivez la disponibilité des places en temps réel</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3>Fiabilité</h3>
                <p>Un système sécurisé et fiable pour vos réservations</p>
            </div>
        </div>
    </section>
