...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) &&
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'create' && !empty($_POST['vehicleType']) && !empty($_POST['vehicleImmatriculation']) && !empty($_POST['carModel'])) {
        ...
        exit();
    } else if (isset($_GET['action']) && $_GET['action'] == "edit" && !empty($_POST['vehicleType']) && !empty($_POST['vehicleImmatriculation']) && !empty($_POST['carModel']) && !empty($_POST['id'])) {
        $vehicleType = cleanString($_POST['vehicleType']);
        $vehicleImmatriculation = cleanString($_POST['vehicleImmatriculation']);
        $carModel = cleanString($_POST['carModel']);
